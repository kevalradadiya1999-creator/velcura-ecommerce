  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(data.error || "Failed to submit contact message");
      }
    } catch (err) {
                ...
                {[
                  {
                    ...
                    label: 'Email', value: 'velcura60@gmail.com', href: 'mailto:velcura60@gmail.com'
                  },
                  {
                    ...
                    label: 'WhatsApp', value: '+91 78630 31769', href: 'https://wa.me/917863031769'
                  },
                  {
